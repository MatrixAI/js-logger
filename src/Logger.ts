class Logger {
    ...
    public info(msg: string, extra?: Record<string, any>): void {
      this.log(msg, 2);
    }
  
    public warn(msg: string, extra?: Record<string, any>): void {
      this.log(msg, 3);
    }
  
    public debug(msg: string, extra?: Record<string, any>): void {
      this.log(msg, 1);
    }
  
    public error(msg: string, extra?: Record<string, any>): void {
      this.log(msg, 4);
    }
  ...
  class Handler {
    ...
    private handleError(error, record): void {
      record = record || null;
  ...
  class ConsoleHandler extends Handler {
    ...
    protected emit = function (record): void {
